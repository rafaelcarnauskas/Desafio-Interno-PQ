...
data = yf.download(tickers, start='2010-01-01', end='2025-12-31', group_by='ticker', threads=False, auto_adjust=True)
...
# Extrai apenas as colunas 'Close' de todos os tickers
close_data = data.xs('Close', level=1, axis=1)
close_data.to_csv('b3-2010-2025-Close.csv')